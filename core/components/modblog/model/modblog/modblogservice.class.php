 ...
 */
/**
 * The base service class for modBlog.
 *
 * @package modblog
 */
class modBlogService {
    /**
    ...
    /**
     * Create an instance of modBlogService.
     *
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $corePath = $this->modx->getOption('modblog.core_path',$config,$this->modx->getOption('core_path').'components/modblog/');
        $assetsUrl = $this->modx->getOption('modblog.assets_url',$config,$this->modx->getOption('assets_url').'components/modblog/');
        ...
        $this->modx->lexicon->load('modblog:default');
    }
