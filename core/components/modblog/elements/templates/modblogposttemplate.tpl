...
<div id="header-wrap">
  <div id="header" class="container_16">
    <h1 id="logo-text"><a href="[[~[[*blog]]]]" title="">modBlog</a></h1>
...
Tags: [[*modblogtags:notempty=`
  <span class="tags" style="float: left;">Tags: [[!tolinks? &useTagsFurl=`1` &items=`[[*modblogtags]]` &target=`[[*blog]]`]]</span>
`]] |
<a href="[[~[[*id]]]]#comments" class="comments">Comments ([[!QuipCount? &thread=`modblogpost-b[[*blog]]-[[*id]]`]])</a>
</p>
<div class="entry">
<p>[[*introtext]]</p>
