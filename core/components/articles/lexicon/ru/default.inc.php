...
$_lang['articles.article'] = 'Запись';
$_lang['articles.article_alias'] = 'Псевдоним (Постоянная ссылка)';
$_lang['articles.article_content'] = 'Содержимое';
$_lang['articles.article_create'] = 'Новая запись';
$_lang['articles.article_delete_multiple'] = 'Удаление нескольких записей';
$_lang['articles.article_delete_multiple_confirm'] = 'Вы действительно хотите удалить выбранные записи?';
$_lang['articles.article_edit'] = 'Редактировать запись';
$_lang['articles.article_options'] = 'Настройки записи';
...
$_lang['articles.articles'] = 'Записи';
$_lang['articles.articles_err_ns_multiple'] = 'Выберите хотя бы одну запись.';
$_lang['articles.articles_import'] = 'Импортировать записи';
$_lang['articles.articles_manage'] = 'Управление записями';
$_lang['articles.articles_none'] = 'Записей еще нет!';
$_lang['articles.articles_search'] = 'Поиск записей...';
$_lang['articles.articles_view'] = 'Показать записи';
$_lang['articles.articles_write_new'] = 'Создать новую запись';
$_lang['articles.author'] = 'Автор';
$_lang['articles.categories'] = 'Категории';
$_lang['articles.comments'] = 'Комментарии';
$_lang['articles.comments.intro_msg'] = 'Здесь вы можете просматривать, утверждать либо отклонять комментарии для всех записей раздела.';
$_lang['articles.container'] = 'Записи';
$_lang['articles.container_alias'] = 'Псевдоним контейнера';
$_lang['articles.container_alias_desc'] = 'Дружественный URL который будет использовать для построения URL этого контейнера записей';
...
/* Latest Posts */
$_lang['articles.setting.latestPostsTpl'] = 'Чанк последних записей';
...
$_lang['articles.setting.notifyTwitterTagLimit'] = 'Шаблон для Twitter';
